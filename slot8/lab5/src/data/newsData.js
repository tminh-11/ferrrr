// Dữ liệu danh sách tin tức cho trang News [cite: 46]
export const newsLists = [
  { 
    ...
    images: '/Images/bbq-chicken.jpg' // Bạn có thể thay bằng 'images/pizza1.jpg' nếu dùng file pizza.zip [cite: 48]
  },
  { 
    id: 2, 
